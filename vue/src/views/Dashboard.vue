<template>
  <div>
    <div style="width: 500px; padding-left:30px;  margin-top:10px;margin-bottom:10px;font-weight: bold; font-size: 32px;">
      城市共享图书驿站
    </div>
    <el-row :gutter="20">
  ...
  data() {
    return {
      cards: [
        ...
        { title: '驿站数', data: 100, icon: '#iconvisit'   },
  ...
  mounted() {
    ...
    request.get("/dashboard").then(res=>{
      if(res.code == 0)
      {
        ...
        this.cards[1].data = res.data.stationCount;
