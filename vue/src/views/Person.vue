    ...
    <el-card style="width: 40%; margin-left: 120px; margin-top: 40px" >
      ...
      <el-form :model="form" ref="form" label-width="80px">
        ...
        <el-form-item label="权限"> 
            <span v-if="form.role==1" style="margin:5px">志愿者</span>
            <span v-if="form.role==2" style="margin:5px">普通读者</span>
        </el-form-item>
        ...
        <el-form-item label="个人介绍">
          <el-input type="textarea" style="width: 80%" v-model="form.discription"></el-input>
        </el-form-item>
      </el-form>
